...
You can integrate FraytWave into any editor or AI assistant that supports the Model Context Protocol (MCP). We have tailored instructions for some of them:
...
For any other editor/assistant, you need to include FraytWave as MCP of type "sse", pointing to the `/tidewave/mcp` path of port your web application is running on. For example, `http://localhost:4000/tidewave/mcp`.
...
| Features                     | FraytWave for Phoenix | FraytWave for Rails |
| :--------------------------- | :------------------: | :----------------: |
| `project_eval`               | ✅                    | ✅                 |
| `package_search`             | ✅                    | ✅                 |
| `package_docs_search`        | ✅                    |                   |
...
you must not enable the FraytWave ones, except for assistants like Claude Desktop:
...
FraytWave stores the timestamps files have been read and written to, to avoid accidentally
